...
MdFilledButton.styles = [styles$a, styles$b, styles$c];
...
MdOutlinedButton.styles = [styles$a, styles$9];
...
/**
  ...
  * SPDX-License-Identifier: Apache-2.0
  */
const styles$7 = i$4 `@media(forced-colors: active){.fab{border:1px solid ButtonText}.fab.extended{padding-inline-start:15px;padding-inline-end:19px}md-focus-ring{--md-focus-ring-outward-offset: 3px}}/*# sourceMappingURL=forced-colors-styles.css.map */
`;
...
MdFab.styles = [styles$6, styles$8, styles$7];
MdFab = __decorate([
    t$3('md-fab')
], MdFab);
